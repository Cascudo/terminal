const RoadmapIcon = ({ width = 16, height = 16 }: { width?: number | string; height?: number | string }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 300" width={width} height={height}>
      <defs>
        <linearGradient id="scenicGradient" x1="0%" y1="0%" x2="100%" y2="100%">
